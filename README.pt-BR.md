...
- **Primeiro boot degradado (P2-112)** — com o daemon local inacessível no primeiro
  ...
  responder, mostra o retry automático visível, mantém os dados locais funcionando —
  o cartão "Disponível offline" traz os dois controles, idioma e tema (P3-368),
  gravando nas mesmas chaves que Configurações → Aparência lê —, dá feedback real no
  "Reconectar agora" (spinner + toast) e deixa o
