...
// the animation-name flip probe) inside the same budget; P2-117 added the
// Scan-QR state-machine beats (camera-blocked boot + fake-camera boot:
// unavailable/preview states, 390px preview, NO SIGNAL fallback, paste CTA),
// growing it to 240s.
