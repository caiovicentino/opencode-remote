...
- [ ] (P2-004) [P2] Diff preview no approval — spec: no card de approval do ChatView.tsx, antes dos botões Approve/Reject mostrar as 3 primeiras linhas do comando/patch pedido (campo metadata.command ou patterns do evento de permissão, já disponível no payload); critério: card mostra contexto legível, typecheck/build verdes.
