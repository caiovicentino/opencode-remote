...
## Done
- [x] (P3-001) [P3] Título da sessão no header do chat — spec: em ChatView.tsx o header deve mostrar o título da sessão atual (buscar via GET /session/:id no mount); critério: título visível, sem regressão de typecheck/build. — merged by pilot 2026-08-31
