...
- [ ] (P2-003) [P2] Ordenar sessões por atividade recente — spec: em SessionsView.tsx ordenar a lista por updatedAt desc (mais recente primeiro) usando o mesmo campo já exibido; critério: lista ordenada, typecheck e build verdes.
