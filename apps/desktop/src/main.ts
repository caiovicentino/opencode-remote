...
// Tray keeps a tiny data-URL glyph (P3-009): the real 512px app icon lives in
// build/icon.png (generated by scripts/make-icon.mjs) and is used for the
// window/dock/About panel — a full-color icon at 16px menu-bar size would be
// noise. Revisit with a dedicated template image when theming lands.
const TRAY_ICON_PNG =
