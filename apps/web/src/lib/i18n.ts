...
export const dict = {
  en: {
    ...
    // P3-412: fail-fast title when the step-2 card's connection state already
    // says the agent is out — ties the QR failure to that card, calmly.
    welcomeQrAgentDown: "The local agent is not running.",
    ...
    missionEmptyHint: "Sessions appear as the pilot works — each run leaves its forensic timeline here.",
    ...
    // P3-402: camera-ask sheet ("Olho") — live viewfinder, shutter-only
    // capture (no streaming), question + photo in one message.
    camOpen: "Open camera",
    camTitle: "Camera",
    camClose: "Close camera",
    camMinimize: "Minimize camera",
    camExpand: "Show camera",
    camStarting: "Starting the camera…",
    camCapture: "Capture photo",
    camTorch: "Flash",
    camSwitch: "Switch camera",
    camQuestionPlaceholder: "Ask something about what you see…",
    camPrivacy: "The photo only leaves your device when you send it.",
    camDraftHint: "Nothing typed — the composer draft and its attachments will be sent.",
    camVisionHint: "The model may not accept images — switch models in the composer selector and try again.",
    "camErr_no-signal": "The camera has no signal — capture devices without input show this.",
    ...
    // P3-404: screen-peek ("Ver a tela") — one frame per explicit request,
    // never streaming; the phone asks, the desktop shell captures.
    screenPeekOpen: "View the machine's screen",
    screenPeekTitle: "Machine screen",
    screenPeekRefresh: "Refresh",
    screenPeekAsk: "Ask about the screen",
    screenPeekQuestionPlaceholder: "What do you want to know about the screen?",
    screenPeekWaiting: "Asking the desktop app for a capture…",
    screenPeekTimeout: "The desktop app didn't respond. Open OpenCode Remote on the machine and tap Refresh again.",
    screenPeekAt: "Captured at {time}",
    screenPeekIndicator: "Screen captured from your phone · {time}",
    screenPeekPickSource: "Capture from another screen or window:",
    screenPeekFailBlocked: "Screen access is denied on the machine. Allow screen capture in its privacy panel and try again.",
    screenPeekFailWillAsk: "The system hasn't decided about screen capture yet. Allow access on the machine and try again.",
    screenPeekFailUnknown: "The screen could not be captured right now. Try again.",
    ...
    voiceSession: "Answer by voice in this chat",
    voiceSessionOn: "Voice answers on in this chat — click to stop",
    playAnswer: "Play answer aloud",
  ...
  pt: {
    ...
    // P3-412: título do fail-fast quando o estado de conexão do passo 2 já
    // diz que o agente está fora — amarra a falha do QR àquele cartão, calmo.
    welcomeQrAgentDown: "O agente local não está em execução.",
    ...
    missionEmptyHint: "As sessões aparecem conforme o piloto trabalha — cada rodada deixa sua timeline forense aqui.",
    ...
    // P3-402: mesmas chaves da câmera-pergunta ("Olho") — viewfinder ao vivo,
    // captura só no shutter (nada de streaming), foto + pergunta numa mensagem.
    camOpen: "Abrir câmera",
    camTitle: "Câmera",
    camClose: "Fechar câmera",
    camMinimize: "Minimizar câmera",
    camExpand: "Mostrar câmera",
    camStarting: "Ligando a câmera…",
    camCapture: "Capturar foto",
    camTorch: "Lanterna",
    camSwitch: "Alternar câmera",
    camQuestionPlaceholder: "Pergunte algo sobre o que você está vendo…",
    camPrivacy: "A foto só sai quando você envia.",
    camDraftHint: "Nada digitado — o rascunho e os anexos do campo de mensagem serão enviados.",
    camVisionHint: "O modelo pode não aceitar imagens — troque o modelo no seletor do composer e tente de novo.",
    "camErr_no-signal": "A câmera não tem sinal — dispositivos de captura sem entrada mostram isso.",
    ...
    // P3-404: mesmas chaves da versão en — um frame por pedido explícito.
    screenPeekOpen: "Ver a tela da máquina",
    screenPeekTitle: "Tela da máquina",
    screenPeekRefresh: "Atualizar",
    screenPeekAsk: "Perguntar sobre a tela",
    screenPeekQuestionPlaceholder: "O que você quer saber sobre a tela?",
    screenPeekWaiting: "Pedindo uma captura ao app desktop…",
    screenPeekTimeout: "O app desktop não respondeu. Abra o OpenCode Remote na máquina e toque em Atualizar de novo.",
    screenPeekAt: "Capturado às {time}",
    screenPeekIndicator: "Tela capturada pelo celular · {time}",
    screenPeekPickSource: "Capturar de outra tela ou janela:",
    screenPeekFailBlocked: "O acesso à tela está negado na máquina. Libere a captura de tela no painel de privacidade e tente de novo.",
    screenPeekFailWillAsk: "O sistema ainda não decidiu sobre a captura de tela. Permita o acesso na máquina e tente de novo.",
    screenPeekFailUnknown: "Não foi possível capturar a tela agora. Tente de novo.",
    ...
    voiceSession: "Responder em voz nesta conversa",
    voiceSessionOn: "Respostas em voz ligadas nesta conversa — clique pra desligar",
    playAnswer: "Ouvir resposta",
