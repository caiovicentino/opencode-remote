...
/** P3-357: row action — pin the conversation to the top of the list. */
...
/** P3-452: pane "go" action in the browser address bar (replaces "→"). */
...
/** P3-452: Browser pane maximize action (replaces the "⤢" glyph). */
...
/** P3-452: Browser pane restore action (replaces the "⤡" glyph). */
...
/** P3-452: screenshot-browser "toggle extracted text" (replaces "≡"). */
...
/** P3-364: pane-map rows — the panes stay locked until the gate clears. */
